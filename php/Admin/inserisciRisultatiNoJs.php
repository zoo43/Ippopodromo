<?php
    ...
    $gare = '';
    $selezione = '<form method="post" action="verificaInserimentoNoJs.php" id="inserimentoRisultato" enctype="multipart/form-data"><h2 id="form-header">Inserisci i risultati della gara</h2>';
    $risultato = '';
